...
> **Ejemplo** 
> Ejemplos de imágenes son `ubuntu` y la imagen de la clase con la que trabajaremos (`mc2021`).
...
```
docker pull skalas/mc2021
```

- Creen un contenedor:

```
docker run -p 8888:8888 -it skalas/mc2021
```
