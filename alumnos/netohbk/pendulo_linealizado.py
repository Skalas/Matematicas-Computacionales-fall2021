class Pendulo:
    ...
    def fasediagrama(self):
        fig, ax = plt.subplots(0,0, figsize=(60,10), sharex = True)
        
        ax[0].plot(self.theta(), self.omega())
        
        ax[0].set_xlabel("theta (rads)")
        
        ax[0].set_ylabel("omega (rads/s)")
